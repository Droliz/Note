...
public class reIndex {  
    ...
    // 汇总文件中单词数   (word:file) : count   =>   word : (file:sum(count))    public static class Combine extends Reducer<Text, Text, Text, Text> {  
    ...
    // 汇总  word : (file:count)   =>  word : (file1:count1 file2:count2)    public static class ReduceTask extends Reducer<Text, Text, Text, Text> {  
